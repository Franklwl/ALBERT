...
class FullTokenizer(object):
  ...
  def __init__(self, vocab_file=None, do_lower_case=True, use_spm=True):
    self.vocab = None
    self.sp_model = None
    if use_spm:
  ...
  @classmethod
  def from_scratch(cls, vocab_file, do_lower_case, use_spm):
    return FullTokenizer(vocab_file, do_lower_case, use_spm)
